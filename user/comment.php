...
if(isset($_POST['submit'])){
	...
	$sql="insert into comments(uid,comment) values('$uid','$cmmnt')";
...
<div align = "center">
	...
	<div class="col-md-6 col-md-offset-3 comments-section">-->
			...
			<form class="clearfix" action="index.php" method="post" id="comment_form">
				...
				<button  name="submit" class="btn btn-primary btn-sm pull-right" type="submit" id="submit_comment">Submit comment</button>
			</form>
